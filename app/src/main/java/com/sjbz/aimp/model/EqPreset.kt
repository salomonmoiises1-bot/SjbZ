...
/**
 * Data model for SjbZ Equalizer presets (32 bands + preamp + MDRC settings).
...
data class MDRCSettings(
    ...
    val bands: List<MDRCBandConfig> = listOf(
        MDRCBandConfig(name = "Sub", cutoffHz = 120f, thresholdDb = -18f, ratio = 3.0f, attackMs = 5f, releaseMs = 80f, gainDb = 0f),
        MDRCBandConfig(name = "Low", cutoffHz = 500f, thresholdDb = -16f, ratio = 2.5f, attackMs = 10f, releaseMs = 100f, gainDb = 0f),
        MDRCBandConfig(name = "Mid", cutoffHz = 2000f, thresholdDb = -14f, ratio = 2.0f, attackMs = 15f, releaseMs = 120f, gainDb = 0f),
        MDRCBandConfig(name = "High", cutoffHz = 8000f, thresholdDb = -12f, ratio = 2.0f, attackMs = 20f, releaseMs = 150f, gainDb = 0f),
        MDRCBandConfig(name = "Air", cutoffHz = 20000f, thresholdDb = -10f, ratio = 2.5f, attackMs = 25f, releaseMs = 180f, gainDb = 0f)
    )
)
